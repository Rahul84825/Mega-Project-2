    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="space-y-10 rounded-2xl border border-[rgba(83,44,22,0.10)]
        ...
        <div className="flex items-start gap-3 rounded-xl border border-[rgba(212,160,23,0.28)]
          ...
          <div>
            <h3 className="mb-1 text-sm font-medium text-[#24140f]">2-Day Return Window</h3>
            <p className="text-[13px] leading-relaxed text-[#6e5443]">
        ...
        {/* Steps */}
        <div>
          <h2 className="mb-5 text-[15px] font-medium text-[#24140f]">
            ...
            {STEPS.map(({ step, title, desc }) => (
              <div key={step}
                ...
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg
                                bg-[#7a2828] text-sm font-medium text-white">
                  {step}
                </div>
                <div>
        ...
        <div className="rounded-xl border border-[rgba(212,160,23,0.25)]
          ...
          <h3 className="mb-2 text-sm font-medium text-[#24140f]">Need help with a return?</h3>
