...
const OrderTabs = ({ activeTab, counts, onSelect }) => {
  return (
    <div className="flex flex-nowrap overflow-x-auto pb-2 gap-2 custom-scrollbar no-scrollbar scroll-smooth">
      {ORDER_TABS.map((tab) => {
        ...
        return (
          <button
            ...
            className={`flex items-center gap-2 rounded-full border px-3.5 py-2 text-xs font-medium transition-all shrink-0
              ${isActive
